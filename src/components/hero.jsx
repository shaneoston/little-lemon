export const Hero = () => {
  return (
    <div className="bg-llgreen">
      <div className="container lg:flex bg-llgreen lg:h-84">
        ...
        <div className="p-6 lg:order-first lg:w-1/2">
          ...
          <button className="bg-llgold w-full px-8 py-3 text-xl font-semibold rounded-lg lg:w-1/2">Reserve a Table
          </button>
        </div>
      </div>
    </div>
